...
docker run --name taskbridge-ondisk -e PORT=3000 -e PERSISTENCE=ONDISK -p 42000:3000 hilderonny2024/taskbridge:2.0.0

# Aufgaben und Statistiken nur im Speicher halten, erhöhte Performance durch fehlende Festplattenzugriffe
docker run --name taskbridge-inmemory -e PORT=3000 -e PERSISTENCE=INMEMORY -p 42000:3000 hilderonny2024/taskbridge:2.0.0
```
...
```sh
docker login
docker build -t hilderonny2024/taskbridge:2.0.0 .
docker push hilderonny2024/taskbridge:2.0.0
```
